    ...
    return (
        <>
            ...
            <div className="container fav">
                <div className="col"><img src={f1} alt="" /> <span className="text-container">Hair Care</span></div>
                <div className="col"><img src={f2} alt="" /><span className="text-container">Organic Soap</span></div>
                <div className="col"><img src={f3} alt="" /><span className="text-container">Skin Care</span></div>
                <div className="col"><img src={f4} alt="" /><span className="text-container">Fragrance</span></div>
            </div>
